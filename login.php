...
if(isset($_POST['LgnBtn'])){
  extract($_POST);
  $q=mysqli_query($con,"select * from login where email='$txtemail' and password='$txtpass'");
  if(mysqli_num_rows($q)>0){
    $_SESSION["email"]=$txtemail;
    $q1=mysqli_query($con,"select * from login where email='".$_SESSION['email']."'");
...
<div class="card" style="width: 18rem;">
  ...
  <ul class="list-group list-group-light list-group-small">
    ...
    <li class="list-group-item px-4">Password:</li>
  ...
  <div class="card-body" style="text-align: center;vertical-align: middle;" >
    ...
    <a href="registration.php">Don't have an account? Create an account</a>
  </div>
</div>
</div>
<div><br><br></div>
